...
public class MainActivity6 extends AppCompatActivity {
    ...
    private childDB locaUserChild = new childDB();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(MainActivity6.this, "Faulty child! Cannot Vaccinate.", Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//                tableRow.addView(tVVaccineName);
            ...
            Toast.makeText(MainActivity6.this, "No vaccination for faulty child!", Toast.LENGTH_LONG).show();
    }
...
*/
                    Intent intentQRValidation = new Intent(MainActivity6.this, MainActivity5_QR.class);
                    ...
                    Toast.makeText(MainActivity6.this, "Selected vaccine is already taken!", Toast.LENGTH_LONG).show();
